...
$(function () {
    var data = {
     ...
     [
         {
             "name": "A",
             "src": "images/Interior/Bedroom/A/BASE_IMAGE.jpg"
         },
         {
             "name": "B",
             "src": "images/Interior/Bedroom/B/BASE_IMAGE.jpg"
         },
         {
             "name": "C",
             "src": "images/Interior/Bedroom/C/BASE_IMAGE.jpg"
         },
         {
             "name": "D",
             "src": "images/Interior/Bedroom/D/BASE_IMAGE.jpg"
         },
         {
             "name": "E",
             "src": "images/Interior/Bedroom/E/BASE_IMAGE.jpg"
         },
         {
             "name": "F",
             "src": "images/Interior/Bedroom/F/BASE_IMAGE.jpg"
         },
         {
             "name": "G",
             "src": "images/Interior/Bedroom/G/BASE_IMAGE.jpg"
         },
         {
             "name": "H",
             "src": "images/Interior/Bedroom/H/BASE_IMAGE.jpg"
         }
     ],
...
//Variables moved from around line 1470 to line 578 by Softronikx 
var color_data = $.getJSON("color.js");
    ...
    activeMode = "bzr"
        ...
        c2.addEventListener('mousedown', function (evt, ui) {
           if(state != null){
                ...
                //new code by  to get selected colour
                ...
                for (var putColor = 0; putColor < canvasColors.length; putColor++) {
                    ...
                    {   
                        ...
                        if(p_hex == existing_colors)
                        {
                            ...
                            /*<li style="display: block; float: left; position: relative; width: 60px; height: 40px; background-color:'+canvasColors[putColor]+';"class="'+putColor+'"></li> Commented by Softronikx */
        ...
        c2.addEventListener('mouseup', function (evt) {
            if (state != null) {
                ...
                //new code by  to remove tooltip of selected colour
                 $('#selected_colour_tooltip').html('');
                 $("#selected_colour_tooltip").hide();
            }
            
                    
            // -> state is 'fill' only when the fill button is clicked.
            if (state == 'fill' || state == 'delete') { //|| state == 'delete' is commented by 
                _max = 0; //-> this probably stores the total number of structures
                //to get which shape os selected
                
                // -> struct[1], struct[2], struct[3] are all structures on the image
                //-> struct[1][1],struct[1][2], struct[1][3],struct[1][4] => these contain the coordinations of structure 1, and so on for structure 2.
            ...
            if (state == 'remove_paint') { //|| state == 'delete' is commented by 
                _max = 0; // -> this probably stores the total number of structures
                //to get which shape os selected
        ...
        function fill(){
            ...
            //new code  if and else condition
...
function grayScale() {
 ...
 //Below two commented by softronikx - , as moved on top, as also used near line 671
...
$(function() {
    ...
    x = can1.toDataURL();
    document.getElementById('preview_image').src = x;*/
    //$(".preview_image").appimend("<div class='printable'>this is demo text to test the printing of the element in html.</div>");
        // Print the DIV.
        //$(".preview_image").print();
        PrintDiv();
        return (false);
